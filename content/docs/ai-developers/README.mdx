...
description: "🤖 AI Developer Documentation - NextChat Documentation"
lastModified: "2025-10-16T18:41:57.732Z"
---
...
Start by reading:
- [Codebase Structure](/docs//docs/project-context/01-codebase-structure.md)
- [Technology Stack](/docs//docs/project-context/02-technology-stack.md)
- [Design Decisions](/docs//docs/project-context/04-design-decisions.md)
...
Always respect:
- [Architectural Constraints](/docs//docs/constraints/01-architectural-constraints.md)
- [Performance Constraints](/docs//docs/constraints/03-performance-constraints.md)
- [Security Constraints](/docs//docs/constraints/04-security-constraints.md)

### 4. Use Workflows
For common tasks, follow:
- [Feature Implementation](/docs//docs/workflows/01-feature-implementation.md)
- [Bug Fixing](/docs//docs/workflows/02-bug-fixing.md)
- [Testing](/docs//docs/workflows/04-testing.md)

### 5. Follow Examples
Model your work after:
- [Component Generation](/docs//docs/examples/01-component-generation.md)
- [API Implementation](/docs//docs/examples/02-api-implementation.md)
- [Test Generation](/docs//docs/examples/03-test-generation.md)
