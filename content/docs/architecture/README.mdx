...
description: "🏛️ Architecture Documentation - NextChat Documentation"
...
| Need | Go To |
|------|-------|
| Understand system | [System Overview](/docs//docs/01-system-overview.md) |
| Learn patterns | [Design Patterns](/docs//docs/02-design-patterns.md) |
| Understand modules | [Module System](/docs//docs/03-module-system.md) |
| Study state mgmt | [State Management](/docs//docs/04-state-management.md) |
| Learn plugins | [Plugin System](/docs//docs/05-plugin-system.md) |
| Know API design | [API Architecture](/docs//docs/06-api-architecture.md) |
| Study components | [Component Architecture](/docs//docs/07-component-architecture.md) |
| Explore styling | [Styling Architecture](/docs//docs/08-styling-architecture.md) |
