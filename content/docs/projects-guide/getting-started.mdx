...
description: "Getting Started - NextChat Documentation"
...
- Read [Agent Interaction](/docs/agent-interaction.md) to understand AI collaboration
- Review [Workflows](/docs/workflows.md) for common patterns
- Check [Prompts](/docs/prompts.md) for complete command reference
- Explore [Visual Guide](/docs/visual-guide.md) for system diagrams
