...
description: "Comprehensive project management system with version-controlled development, plan analysis, and automated commit integration"
...
- **Templates**: [Project Templates](./templates/) - Project templates for different types
- **Plans**: [Plan Analysis](./plans/) - Plan analysis framework and tools
- **Versions**: [Version Tracking](./versions/) - Version-specific documentation
- **Migration Log**: [Migration History](./migration-log) - Migration history and notes
