---
title: "Plan Analysis Framework"
description: "Comprehensive framework for analyzing, validating, and optimizing project plans with version-controlled tracking"
audience: ["project-managers", "ai-agents", "developers"]
