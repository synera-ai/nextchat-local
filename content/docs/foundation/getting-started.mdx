...
[Get API Keys →](./quick-reference#api-keys)

## Next Steps

### Want to Learn More?
- 📖 [Architecture Overview](./architecture-overview) - How NextChat works
- 👥 [Project Management](./project-management) - How projects are organized
- 🤖 [AI Agent Integration](./ai-agent-integration) - Contributing code

### Need Help?
- 🔍 [Quick Reference](./quick-reference) - FAQs and common questions
...
**Ready to explore?** Head to [Architecture Overview](./architecture-overview) to understand how NextChat works, or jump to [Project Management](./project-management) if you want to contribute.