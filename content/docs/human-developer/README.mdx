---
title: "Human Developer Documentation"
description: "Human Developer Documentation - NextChat Documentation"
...
1. **New to NextChat?** Start with [Getting Started](/docs/getting-started/README.md)
2. **Setting Up?** Follow the [Installation Guide](/docs/installation/README.md)
3. **Configuring?** Check [Configuration Options](/docs/configuration/README.md)
4. **Need Help?** See [Troubleshooting](/docs/troubleshooting/README.md)
...
- **Documentation Issues**: Check the [troubleshooting guide](/docs/troubleshooting/README.md)
- **Configuration Problems**: See [configuration section](/docs/configuration/README.md)
- **Installation Issues**: Review [installation guide](/docs/installation/README.md)
- **General Questions**: Browse the [FAQ](/docs/faq/README.md)
