...
description: "AI Coding Best Practices - NextChat Documentation"
...
See [API Documentation](/docs//docs/api.md) for detailed API reference.
```
...
- [AI Project Management Practices](/docs/project-management/README.md)
- [AI Code Quality Practices](/docs/code-quality/README.md)
- [AI Testing Practices](/docs/testing/README.md)
- [AI Deployment Practices](/docs/deployment/README.md)
- [AI Maintenance Practices](/docs/maintenance/README.md)
